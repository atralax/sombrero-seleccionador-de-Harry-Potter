...
for i in [1,2,3,4]:
    contador = 0
    casa_ganadora = 0
    print(lista_de_preguntas.count(i))
...
#elijo casa 
print
if   i==1:  print("Griffindor")

elif i==2:  print("Slytherin")

elif i==3:  print("Hufflepuff")

elif i==4 :  print("Ravenclaw")